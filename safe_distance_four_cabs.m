...
function [x, y, z, w, v_y, v_z, v_w] = plot_safe_distance(D, k, dt, a_max, d_max, t, u, fig_num)
    [rows, cols] = size(t);
    x = zeros(1, cols);
    y = zeros(1, cols);
    z = zeros(1, cols);
...
u1 = 15 * ones(1, cols);
[x1, y1, z1, w1, v_y1, v_z1, v_w1] = plot_safe_distance(D, k, dt, a_max, d_max, t, u1, 1);
...
[x2, y2, z2, w2, v_y2, v_z2, v_w2] = plot_safe_distance(D, k, dt, a_max, d_max, t, u2, 3);
...
[x3, y3, z3, w3, v_y3, v_z3, v_w3] = plot_safe_distance(D, k, dt, a_max, d_max, t, u3, 5);